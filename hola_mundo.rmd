...
Cuando pulsa el boton **Knit** se genera un documento que incluye tanto el contenido como la salida de cualquier trozo de codigo R embebido dentro del documemto. Puede incrustar partes de codigo R como este:
...
Tambien puede insetar graficos, por ejemplo:
